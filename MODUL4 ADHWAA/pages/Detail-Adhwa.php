...
$sql = "SELECT * FROM showroom_adhwa_table WHERE id_mobil = $id";
...
<head>
  ...
  <title>Detail Car - Adhwa_1202204172</title>
        ...
        echo "
                ...
                <div class='d-flex justify-content-center align-items-start gap-5 mt-5'>
                  ...
                  <form action='' enctype='multipart/form-data'>
                    ...
                    <a href='Edit-Adhwa.php?id=" . $getDetail["id_mobil"] . "' class='btn btn-primary' style='margin-top: 40px;'>Edit</a>
                  </form>
                </div>
            ";
      }
