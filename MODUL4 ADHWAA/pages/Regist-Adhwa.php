...
<nav class="navbar navbar-expand-lg bg-primary">
    ...
    <div class="d-flex justify-content-center align-items-center" style="margin-top: 50px;">
        <div class="col-md-3">
            <div class="card">
                <form action="../config/regist.php" method="POST">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <label class="form-label" for="NoHp">  <b>NoHp</b></label>
                            <input type="number" class="form-control" name="NoHp" id="NoHp" placeholder="Masukkan NoHp" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" class="form-control" name="new password" id="password" placeholder="Konfirmasi Kata Sandi Anda" required>
                        </div>
            ...
            <h6 class="mb-4" style="text-align: center;">Anda sudah punya akun? <a href="Login-Adhwa.php">Login</a></h6>
        </div>
    </div>
